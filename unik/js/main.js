...
function initSwiper() {
    ...
    const homeContentSlider = document.querySelector('.js-home-content-swiper:not(.swiper-initialized)');
const homeImageSlider = document.querySelector('.js-home-image-swiper:not(.swiper-initialized)');

if (homeContentSlider && homeImageSlider) {
    // Слайдер с контентом (эффект fade)
    const contentSwiper = new Swiper('.js-home-content-swiper:not(.swiper-initialized)', {
        modules: [Keyboard, Navigation, Pagination, EffectFade, Autoplay, Controller],
        keyboard: {
            enabled: true,
            onlyInViewport: true,
        },
        ...
        // Отключаем свайпы на контент-слайдере
    ...
    // Слайдер с изображениями (обычный слайд)
    const imageSwiper = new Swiper('.js-home-image-swiper:not(.swiper-initialized)', {
        modules: [Keyboard, Navigation, Pagination, EffectFade, Controller],
    ...
    // // Синхронизация кнопок навигации
    // const prevBtn = homeContentSlider.querySelector('.js-home-swiper-prev');
    // const nextBtn = homeContentSlider.querySelector('.js-home-swiper-next');
    ...
    // const paginationEl = homeContentSlider.querySelector('.js-home-swiper-pagination');
    // if (paginationEl) {
    //     // Обновляем активный bullet при смене слайда
    //     const updatePagination = () => {
    //         const activeIndex = imageSwiper.realIndex;
    ...
    //     imageSwiper.on('slideChange', updatePagination);
    //     contentSwiper.on('slideChange', updatePagination);
    //     updatePagination();
    // }
}
            ...
            if (productSliderSwiperEl) {
                ...
                if (productThumbsSwiperEl) {
                    ...
                    productThumbsSwiperEl.addEventListener('click', (event) => {
                        ...
                        const swiperSlideVisible = target.classList.contains('swiper-slide-visible') ? target : target.closest('.swiper-slide-visible');
